...
<body style="background-color:#CEAB93;">
    <header>
        <center>
            <h3>Formulir Edit Data Siswa</h3>
        </center>
    </header>
    <form action="proses-edit.php" method="POST" enctype="multipart/form-data" style="background-color:#E3CAA5;">
        <fieldset>
            ...
            <p>
                ...
                <input type="text" name="nisn" placeholder="NISN" value="<?php echo $siswa['nisn'] ?>" />
            </p>
            <p>
            ...
            <p>
                ...
                <input type="text" name="level" placeholder="Level" value="<?php echo $siswa['level'] ?>" />
            </p>
            <p>
                <label>Foto</label>
                <input type="file" name="file" class="file" accept="image/*">
                <input type="hidden" value="<?php echo $siswa['foto']?>" name="default">
            </p>
            <p>
